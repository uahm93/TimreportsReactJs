...
export default class LineDemo extends Component {
	...
	componentDidMount() {
		...
		let url = 'https://timreports.expidetufactura.com.mx/tboreport/public/grafica';
					...
					datasets: [
						{
							...
							pointBorderColor: '#a2832f',
							pointBackgroundColor: '#fff',
							pointBorderWidth: 1,
							pointHoverRadius: 5,
							pointHoverBackgroundColor: '#a2832f',
